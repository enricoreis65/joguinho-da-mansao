...
def carrega_spritesheet(spritesheet, linhas, colunas):
    ...
    Keyword Arguments:
    spritesheet -- imagem das animações
    linhas -- quantia de linhas que a imagem ocupa
    colunas -- quantia de colunas que a imagem ocupa
    """
...
def load_assets(img_dir):
    ...
    # - Imagens do cenário e telas:
    assets[GAMEOVER1] = pygame.transform.scale(assets[GAMEOVER1], (largura, altura))
    assets[GAMEOVER2] = pygame.transform.scale(assets[GAMEOVER2], (largura, altura))
    assets[TELA_INICIAL_IMG] = pygame.transform.scale(assets[TELA_INICIAL_IMG],(largura,altura))
    # - Imagens dos botões:
    assets[PLAY] = pygame.transform.scale(assets[PLAY],(botao_largura, botao_altura))
    assets[PLAYAPERTADO] = pygame.transform.scale(assets[PLAYAPERTADO],(botao_largura,botao_altura))
    assets[MENU] = pygame.transform.scale(assets[MENU],(botao_largura, botao_altura))
    assets[MENUAPERTADO] = pygame.transform.scale(assets[MENUAPERTADO],(botao_largura, botao_altura))
    assets[TUTORIAL] = pygame.transform.scale(assets[TUTORIAL],(largura, altura))
    assets[SAIR] = pygame.transform.scale(assets[SAIR], (botao_largura, botao_altura))
    assets[SAIRAPERTADO] = pygame.transform.scale(assets[SAIRAPERTADO], (botao_largura, botao_altura))
    assets[RESUME] = pygame.transform.scale(assets[RESUME], (botao_largura, botao_altura))
    assets[RESUMEAPERTADO] = pygame.transform.scale(assets[RESUMEAPERTADO], (botao_largura, botao_altura))
    assets[NEXT] = pygame.transform.scale(assets[NEXT], (botao_largura, botao_altura))
    assets[NEXTAPERTADO] = pygame.transform.scale(assets[NEXTAPERTADO], (botao_largura, botao_altura))
    # - Imagens das pistas e chaves para passar de nível:
    assets[CARTA] = pygame.transform.scale(assets[CARTA],(adicionais_largura, adicionais_altura))
    assets[CARTA_ABERTA] = pygame.transform.scale(assets[CARTA_ABERTA],(carta_aberta_largura,carta_aberta_altura))
    assets[PEGADAS] = pygame.transform.scale(assets[PEGADAS],(adicionais_largura,adicionais_altura))
    ...
    assets[Chave1]=pygame.transform.scale(assets[Chave1], (adicionais_largura, adicionais_altura))
    assets[Chave2]=pygame.transform.scale(assets[Chave2], (adicionais_largura, adicionais_altura))
    assets[Chave3]=pygame.transform.scale(assets[Chave3], (adicionais_largura, adicionais_altura))
